...
// 点击标题
protocol LTBTitleViewDelegate : class {
    func titleView(_ titleView : LTBTitleView, currentIndex : Int)
}

class LTBTitleView: UIView {

    
    // MARK: 定义属性
    weak var delegate : LTBTitleViewDelegate?
    ...
    // MARK: 构造函数
    init(frame: CGRect, titles : [String], style : LTBTitleStyle) {
...
extension LTBTitleView : LTBContentViewDelegate {
